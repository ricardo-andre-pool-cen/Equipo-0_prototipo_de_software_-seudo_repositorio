...
Carlos Alberto Espadas Canul | 1
...
>El sprint backlog trata de como los desarrolladores desean tratar los sprint, describe el porque y como del sprint.

Este consta de varios puntos

- El "goal" de sprint: Describe el objetivo del sprint
...
- El goal sprint: Esta destinado para el enfoque scrum y un objetivo para medir el proceso
- El objetivo: El porque del sprint aportara valores a las partes interesadas, como al usuario y alcliente.
 Planificacion:
- Es creado por todo el equipo del scrum, todos del equipo trabajaran  en los elementos del objetivo para proporcionar un mejor trabajo en equipo.
...
- Solo debe de haber un Sprint backlog
...
>Comprender como crear y mantener un Sprint backlog eficaz se debe de evitar lo que NO SE BEDE HACER.

El sprint backlog:

- No debe omitir su "goal"
- Solo es una descripción de los elementos del balcklog
- No cambia su "goal", pero los desarrolladores si adaptan o cambian la forma en que lo logran
- No se actualiza a medida que avanza el sprint
- Solo se actualiza durante el daily scrum
- Nunca incluye un elemento de mejora, en otras palabras, el equipo identifica algunos cambios para mejorar su efectividad de trabajo y estos se incluyen cuando sea necesario.
- Debe ser visible para las partes interesadas, pero no podrán modificarlo
- Solo lo actualiza el scrum master para mayor eficiencia.
- Debe de reflejar el estado actual de todo el trabajo para el sprint
...
Para implementar este artefacto, primero refinamos los 7 requisitos funcionales, eliminamos los que definitivamente no tendremos y pasamos los que sobren, tambien modificamos los que ya estaban para conservar la cohesión. Ya despues pasamos nuestros requisitos funcionales a este formato, para trabajarlos como si fueran peticiones de gente real.

Con esas peticiones, vamos a trabajar el diseño de nuestro prototipo.
